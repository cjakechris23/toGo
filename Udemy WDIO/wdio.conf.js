   ...
   capabilities: [
    {
        ...
        'wdio:edgedriverOptions': { // or 'wdio:geckodriverOptions', 'wdio:edgedriverOptions'
            binary: 'msedgedriver.exe' // or 'geckodriver', 'msedgedriver'
    }
}
   ],
    /* capabilities: [
    ...
    before: function(capabilities, specs){
        browser.addCommand("customFileUpload", async (path, uploadBoxSelector, submitUploadSelector) =>{
            await $(uploadBoxSelector).setValue(path)
