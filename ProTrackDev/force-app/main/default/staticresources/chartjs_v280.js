...
!(function (t, e) {
    ...
    q = {
      ...
      arrayEquals: function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          if (
            ((a = t[i]), (r = e[i]), a instanceof Array && r instanceof Array)
          ) {
          ...
          i.borderWidth &&
            ("inner" === i.borderAlign
              ? (e.beginPath(),
                ...
                i.innerRadius > r
                  ? ((t = r / i.innerRadius),
                    e.arc(i.x, i.y, i.innerRadius - r, a + t, n - t, !0))
          ...
          return e.labels.length && e.datasets.length
            ? e.labels.map(function (i, n) {
                ...
                return {
                  text: i,
                  fillStyle: Zt(
                    [s.backgroundColor, r.backgroundColor, l.backgroundColor],
                    void 0,
                    n
                  ),
                  strokeStyle: Zt(
                    [s.borderColor, r.borderColor, l.borderColor],
                    void 0,
                    n
                  ),
                  lineWidth: Zt(
                    [s.borderWidth, r.borderWidth, l.borderWidth],
                    void 0,
                    n
                  ),
  ...
  var Xt = kt.extend({
    ...
    update: function (t) {
      ...
      if (g < 2 * Math.PI) {
        var p = o.rotation % (2 * Math.PI),
          v =
            (p += 2 * Math.PI * (p >= Math.PI ? -1 : p < -Math.PI ? 1 : 0)) + g,
          ...
          k =
            (p <= -Math.PI && -Math.PI <= v) || (p <= Math.PI && Math.PI <= v),
          w =
            (p <= 0.5 * -Math.PI && 0.5 * -Math.PI <= v) ||
          ...
          S = {
            x: k
              ? -1
              : Math.min(y.x * (y.x < 0 ? 1 : M), b.x * (b.x < 0 ? 1 : M)),
            y: w
              ? -1
              : Math.min(y.y * (y.y < 0 ? 1 : M), b.y * (b.y < 0 ? 1 : M))
          },
          D = {
            x: x
              ? 1
              : Math.max(y.x * (y.x > 0 ? 1 : M), b.x * (b.x > 0 ? 1 : M)),
            y: _
              ? 1
              : Math.max(y.y * (y.y > 0 ? 1 : M), b.y * (b.y > 0 ? 1 : M))
          },
    ...
    updateElement: function (t, e, i) {
      ...
      (i && s.animateRotate) ||
        ((v.startAngle =
          0 === e ? o.rotation : n.getMeta().data[e - 1]._model.endAngle),
    ...
    getMaxBorderWidth: function (t) {
      ...
      for (e = 0, i = t.length; e < i; ++e)
        (a = t[e]),
          "inner" !==
            (o = r ? r._resolveElementOptions(a, e) : a._options).borderAlign &&
            ((s = o.borderWidth),
  ...
  var ie = kt.extend({
      ...
      update: function (t) {
        ...
        for (
          u && 0 !== r._model.tension && n.updateBezierControlPoints(),
            e = 0,
            i = o.length;
          e < i;
          ++e
          ...
          return e.labels.length && e.datasets.length
            ? e.labels.map(function (i, n) {
                ...
                return {
                  ...
                  strokeStyle: ne(
                    [o.borderColor, r.borderColor, s.borderColor],
                    void 0,
                    n
                  ),
                  lineWidth: ne(
                    [o.borderWidth, r.borderWidth, s.borderWidth],
                    void 0,
                    n
                  ),
                  hidden: isNaN(r.data[n]) || a.data[n].hidden,
      ...
      if (t) {
        ...
        ut.each(v, function (t) {
          var e,
            i = t.isHorizontal();
          i
            ? ((e = t.update(t.fullWidth ? y : _, b / 2)), (k -= e.height))
          ...
          this._plugins.concat(a.plugins || []).forEach(function (t) {
            if (-1 === i.indexOf(t)) {
              var e = t.id,
                a = r[e];
              !1 !== a &&
                (!0 === a && (a = ut.clone(ot.global.plugins[e])),
                i.push(t),
      ...
      e.scales &&
        ...
        ut.each(n, function (e) {
          ...
          if (r in i && i[r].type === o)
            ...
            if (!l) return;
            (s = new l({ id: r, type: o, options: n, ctx: t.ctx, chart: t })),
              (i[s.id] = s);
          }
  ...
  var fi = gt.extend({
      ...
      update: function (t, e, i) {
        ...
        for (
          ...
          (o = r[n]),
            (l = s[n]) ? (l.label = o) : s.push((l = { label: o, major: !1 }));
        return (
          (u._ticks = s),
          ...
          if (
            ...
            if (p)
              (R = e.left + (e.right - e.left) / 2),
                (L =
                  "bottom" === f ? e.bottom - Y - T.bottom : e.top + Y + T.top);
            else {
              var N = "left" === f;
        ...
        if (
          ...
          ut.each(n, function (n, a) {
            var o = i.getDatasetMeta(a),
              l = [
                o.type,
                void 0 === e.stacked && void 0 === o.stack ? a : "",
                o.stack
              ].join(".");
            void 0 === s[l] &&
  ...
  var Si = fi.extend({
      ...
      getPixelForValue: function (t) {
        ...
        return (
          ...
          t !== n &&
            (0 === n &&
              ((e -= h = ki(s.fontSize, ot.global.defaultFontSize)), (n = d)),
          ...
          (n._unit =
            ...
            (function (t, e, i, n, a) {
              ...
              for (r = ji.length - 1; r >= ji.indexOf(i); r--)
                if (
                  ((o = ji[r]),
                  Bi[o].common && t._adapter.diff(a, n, o) >= e.length)
                )
                  return o;
              ...
              a.offset &&
                ...
                (a.time.min ||
                  ...
                  (s =
                    1 === e.length
                      ? 1 - r
                      : (qi(t, "time", e[1], "pos") - r) / 2)),
                a.time.max ||
                  ((o = qi(t, "time", e[e.length - 1], "pos")),
                  (l =
                    1 === e.length
                      ? o
                      : (o - qi(t, "time", e[e.length - 2], "pos")) / 2))),
              { start: s, end: l }
            );
          })(n._table, u, 0, 0, o)),
      ...
      ((function (t, e) {
        t.exports = (function () {
          ...
          function S(t, e) {
            ...
            return h(function () {
              if (
                (null != n.deprecationHandler && n.deprecationHandler(null, t),
                i)
              ) {
          ...
          function Tt(t, e) {
            return function (i) {
              return null != i
                ? (It(this, t, i), n.updateOffset(this, e), this)
                : Ot(this, t);
            };
          }
          function Ot(t, e) {
          ...
          var qt = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split(
              "_"
            ),
              ...
              if (
                !(function (t, e, i) {
                  if (t) {
                    ...
                    if (n !== a)
                      return (f(i).weekdayMismatch = !0), (i._isValid = !1), !1;
                  }
                  return !0;
                })(l[1], u, t)
              )
            ...
            if (t._f !== n.ISO_8601)
              if (t._f !== n.RFC_2822) {
                ...
                var e,
                  ...
                  u = 0;
                for (
                  a = U(t._f, t._locale).match(z) || [], e = 0;
                  e < a.length;
                  e++
                )
                  (r = a[e]),
                    (i = (s.match(dt(r, t)) || [])[0]) &&
                      ...
                      (u += i.length)),
                    E[r]
                      ? (i ? (f(t).empty = !1) : f(t).unusedTokens.push(r),
                        mt(r, i, t))
          ...
          function Re(t, e) {
            var i, n;
            if ((1 === e.length && a(e[0]) && (e = e[0]), !e.length))
              return Ie();
          ...
          function We(t) {
            ...
            (this._isValid = (function (t) {
              for (var e in t)
                if (-1 === Ct.call(Le, e) || (null != t[e] && isNaN(t[e])))
                  return !1;
          ...
          function Ee(t, e) {
            ...
            return e._isUTC
              ? ((i = e.clone()),
                (a =
                  (x(t) || l(t) ? t.valueOf() : Ie(t).valueOf()) - i.valueOf()),
                  ...
                  (a =
                    r.isValid() && o.isValid()
                      ? ((o = Ee(o, r)),
                        r.isBefore(o)
                          ? (l = $e(r, o))
                          : (((l = $e(o, r)).milliseconds = -l.milliseconds),
                            (l.months = -l.months)),
                        l)
          ...
          (bi.add = Je),
            ...
            (bi.diff = function (t, e, i) {
              ...
              switch (
                ((a = 6e4 * (n.utcOffset() - this.utcOffset())), (e = R(e)))
              ) {
                case "year":
                  r = ti(this, n) / 12;
                  break;
            ...
            (bi.endOf = function (t) {
              ...
              switch (t) {
                ...
                case "quarter":
                  e =
                    i(this.year(), this.month() - (this.month() % 3) + 3, 1) -
                    1;
                  break;
                case "month":
                ...
                case "hour":
                  (e = this._d.valueOf()),
                    (e +=
                      oi -
                      li(e + (this._isUTC ? 0 : this.utcOffset() * ri), oi) -
                      1);
                  break;
                case "minute":
            ...
            (bi.startOf = function (t) {
              ...
              switch (t) {
                ...
                case "hour":
                  (e = this._d.valueOf()),
                    (e -= li(
                      e + (this._isUTC ? 0 : this.utcOffset() * ri),
                      oi
                    ));
                  break;
                case "minute":
            ...
            (bi.isDSTShifted = S(
              ...
              function () {
                ...
                if ((v(t, this), (t = Te(t))._a)) {
                  ...
                  this._isDSTShifted =
                    this.isValid() && w(t._a, e.toArray()) > 0;
          ...
          return (
            ...
            (Qi.as = function (t) {
              ...
              if ("month" === (t = R(t)) || "quarter" === t || "year" === t)
                switch (
                  ((e = this._days + n / 864e5), (i = this._months + Pi(e)), t)
                ) {
                  case "month":
                    return i;
                  case "quarter":
  ...
  var cn = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (n = 0; n < o; ++n)
          (r = l[n]) &&
            ((r.fill = ln(l, n, s)), (r.boundary = sn(r)), (r.mapper = un(r)));
      },
            ...
            (function (t, i, n) {
              if (!(isNaN(f) || f <= 0)) {
                ...
                if (
                  ...
                  0 !== o && u.strokeRect(t, i, f, c), u.fillRect(t, i, f, c);
                u.restore();
              }
            })(y, b, n),
            (g[d].left = y),
  ...
  (function () {
    ...
    (ut.where = function (t, e) {
      ...
      (ut.getRelativePosition = function (t, e) {
        ...
        return {
          x: (i = Math.round(
            (((i - o.left - l) / c) * r.width) / e.currentDevicePixelRatio
          )),
          y: (n = Math.round(
            (((n - o.top - u) / f) * r.height) / e.currentDevicePixelRatio
          ))
        };
      }),
      ...
      (ut.color = G
        ? function (t) {
            return (
              t instanceof CanvasGradient && (t = ot.global.defaultColor), G(t)
            );
          }
        : function (t) {
